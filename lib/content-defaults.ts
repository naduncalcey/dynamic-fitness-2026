...
export const aboutDefaults: AboutContent = {
  ...
  ctaText: "Set Route",
  ctaLink:
    "https://www.google.com/maps/dir//Dynamic+Fitness+(Pvt)+Ltd,+14+Sri+Devananda+Rd,+Maharagama+10280/@6.8523328,79.912721,16z/data=!4m8!4m7!1m0!1m5!1m1!1s0x3ae25b00267d1985:0xc9c0845e8629e66b!2m2!1d79.9138617!2d6.8553051?entry=ttu&g_ep=EgoyMDI2MDMxOC4xIKXMDSoASAFQAw%3D%3D",
...
export const pricingDefaults: PricingContent = {
  ...
  individualPlans: [
    ...
    },
    {
      ...
      price: "රු 42,000",
      priceSuffix: "",
      features: [{ text: "Everything in 6 months", accent: true }],
      cta: "Get Started",
    },
  ],
  couplePlans: [
  ...
  testimonials: [
    {
      name: "Imasha Sashini",
      photo:
        "https://lh3.googleusercontent.com/a/ACg8ocK17GUmhJvH_pMQyFD7WGe2Fx9pFYHEBW1wc6iChYhCBJ-HKA=s128-c0x00000000-cc-rp-mo",
      rating: 5,
    ...
    },
    {
      ...
      photo:
        "https://lh3.googleusercontent.com/a/ACg8ocJnaZaZeLRAlsK0HeGvQfkWxof5PmLxQiBpGupJzCQ0DyvQUw=s128-c0x00000000-cc-rp-mo",
      rating: 5,
    ...
    },
    {
      name: "Sasindu Mendis",
      photo:
        "https://lh3.googleusercontent.com/a-/ALV-UjXq-dAGCepkvDUd6O3VMlRLdLD8Nl92UMTS2nQ32YGSBx__EywfEQ=s128-c0x00000000-cc-rp-mo-ba4",
      rating: 5,
...
export const careersDefaults: CareersContent = {
  headline: "Careers",
  description:
    "We're always looking for passionate people to join our team. Check back soon for open positions.",
};
...
export const allDefaults: Record<string, Record<string, unknown>> = {
  home: {
    hero: heroDefaults,
    about: aboutDefaults,
